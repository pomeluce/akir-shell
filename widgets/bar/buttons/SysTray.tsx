...
export default function () {
    const items = Variable.derive([
        bind(Tray.get_default(), "items"),
        options.systray.ignore,
    ], (items, ignore) => items.filter(i => !ignore.includes(i.id)))

    return <box onDestroy={() => items.drop()}>
